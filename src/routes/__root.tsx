...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover the world's largest music library — chart toppers, demos, secret tracks, remixes, and DJ sets you can't find anywhere else." },
